...
public class Admin extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(admin_id, javax.swing.GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         try {
            ...
            String str = "insert into admin values('"+admin_id.getText()+"','"+admin_name.getText()+"','"+admin_Mobile.getText()+"','"+admin_address.getText()+"','"+status.getSelectedItem()+"')";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            Class.forName(driver);
            Connection con = DriverManager.getConnection(url, username, password);
            String str = "Update admin Set admin_name= '"+admin_name.getText()+"',admin_mobile = '"+admin_Mobile.getText()+"',admin_address = '"+admin_address.getText()+"', status = '"+status.getSelectedItem()+"' where admin_id = '"+admin_id.getText()+"' ";
            st = con.createStatement();
            st.execute(str);
